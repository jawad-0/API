...
// GET endpoint
app.get("/getAssignedCourses/:f_id", async (req, res) => {
  try {
...
// GET endpoint
app.get("/getAssignedTo/:c_id", async (req, res) => {
  try {
...
// POST endpoint
app.post("/addAssignedCourse", async (req, res) => {
  try {
...
// DELETE endpoint
app.delete("/deleteAssignedCourse/:ac_id", async (req, res) => {
  try {
...
app.put("/editRole/:c_id/:f_id", async (req, res) => {
  try {
